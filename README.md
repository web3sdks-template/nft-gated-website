...
We use an [Edition Drop](https://docs.web3sdks.com/pre-built-contracts/edition-drop) contract to enable users to claim one of the NFTs, and serve users
...
- [Auth](https://docs.web3sdks.com/building-web3-apps/authenticating-users): To ask users to sign a message and verify they own the wallet they claim to be, while on the server-side.
...
```bash
npx web3sdks create --template nft-gated-website
```

- Create an [Edition Drop](https://web3sdks.com/contracts/new/pre-built/drop/edition-drop) contract using the dashboard.
...
WEB3SDKS_AUTH_PRIVATE_KEY=your-wallet-private-key
```
...
function MyApp({ Component, pageProps }) {
  return (
    <Web3sdksProvider
      ...
      authConfig={{
        domain: domainName, // This can be any value. e.g. "web3sdks.com"
        authUrl: "/api/auth",
        loginRedirect: "/",
      }}
    >
